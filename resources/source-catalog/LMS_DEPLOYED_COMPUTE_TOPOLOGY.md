...
- `LMA-790-2-LMS` targets under `NAS9-1100`: `67-14186` Volume I; `67-14187`/`67-14188` Volume II operating sections; `67-16127` Volume II Section 7 output tables.
...
- Organization: NASA Manned Spacecraft Center bibliographic control.
- Source: https://www.ibiblio.org/apollo/NARASWoverflow/CorporateIndex.pdf
- Grumman entry: `LLR-400-329` — 06-07-67 — MSC accession `67-15490` — `NAS9-1100` — *CONTRACT NAS9-1100, LMS MISSION EFFECTS PROJECTOR PROGRAM REVIEW*.
- Source class: primary NASA bibliographic-control record.
...
- Aero Service Corporation, July 1969; Contract `NAS 9-5981`; prepared for NASA MSC; NTRS `19690026999`.
- Direct NASA scan: https://ntrs.nasa.gov/api/citations/19690026999/downloads/19690026999.pdf
- Source class: primary contractor technical report delivered to NASA.
- Supports terrestrial/lunar LMS film-graphics production; NASA/Grumman/Farrand coordination on film characteristics; and CCA No. 3 (30 Nov. 1967), which required Lunar-Orbiter-based enhanced lunar samples and explicitly required the technique to be applicable to film graphics for Mission Effects Projector use.
- Records delivery of the enhanced black-and-white and magenta Range 4 samples on 11 Jan. 1968.
- Does **not** establish projector hardware architecture, DDP-224 ownership, EVDE relationship, vendor succession, site effectivity, cadence, or Apollo 13 configuration.

## NASA SP-4009 — Farrand/Itek MEP lead

- NASA *The Apollo Spacecraft: A Chronology*, Vol. IV, week ending 25 Aug. 1967.
- Authoritative NASA historical synthesis, not the underlying configuration record.
- Reports that a Farrand-designed/built MEP did not meet established specifications and that Grumman judged Itek's proposed study most technically acceptable; cites `MSC, BMR Bethpage, Weekly Activities Report, Week Ending August 25, 1967`, 30 Aug. 1967.
- Use as a retrieval lead and corroboration. Do not promote Farrand→Itek succession as primary-source closed until the cited weekly report or equivalent contemporaneous procurement/configuration record is recovered.
...
- Explicitly identifies the Volume I *Simulator Description* title plus Volume II Sections 1 and 4 as GAEC `LMA 790-2-LMS`, Apr. 1, 1967.
- Independently closes title→report-family crosswalk; does not prove a particular hosted scan is accession `67-14186`.
...
- NASA-published historical synthesis, `NASA-CR-182505`, NTRS `19880069935`, March 1988.
- Supports initial two-computer LMS allocation, 8K words common memory, later third LMS computer, and that added computer's onboard-computer simulation role.
- Authoritative secondary evidence, not configuration-controlled documentation.
...
- Retrospective first-person evidence recalling four DDP-224 computers in the Houston LMS complex/room; does not resolve why this differs from NASA's three-machine LMS definition.
...
- pursue RG 255 E.155B/E.155B1 configuration/acceptance files and Apollo 13-period configuration records.
