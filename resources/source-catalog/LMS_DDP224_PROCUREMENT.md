# LMS DDP-224 procurement sources

Status: active companion catalog to `LMS_DEPLOYED_COMPUTE_TOPOLOGY.md`.
...
Procurement complex count is a separate evidence layer from:

- TN D-7112 mature LMS three-machine functional architecture;
- Jackson's retrospective four-DDP-224 Houston-room observation;
- KSC-GP-421F's two surviving LMS-2-provenance DDP-224 systems selected for 1973 reuse.

Do not reconcile these counts arithmetically because they describe different units, dates, and evidentiary questions.
