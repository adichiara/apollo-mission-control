# Apollo 13 Flight Director Log — source catalog

Date: 2026-09-15

## Digitized primary record
...
- RTCC / RTACF;
- job/run identifiers or calculation handoffs.
...
Use with `PC2_GDA_TRIM_SOURCES.md` and `PC2_RTCC_MASS_PROPERTIES_SOURCES.md`. Notes 158–162 already establish that no final crew-entered N48 trim was required; this log is being sought for the **upstream controller rationale**, not for a presumed missing final N48 pair.