...
| MIT/IL `R-567`, Section 5, Revision 11, *Guidance Equations*, cumulative front matter | Preserves a historical revision-index sheet explicitly headed **Section 5 — Guidance Equations (Revision 4)**. The sheet's legend says dagger-marked entries are additional material added in Revision 7; PCR 636 (*November, 1968 GSOP Section 5 Corrections in Landing Program*) is unmarked | Primary-document recovery evidence for Section 5 Revision 4 and for separating later cumulative additions. Dagger-marked rows must not be attributed to Revision 4 solely from this sheet. Does **not** establish Apollo 11 flight effectivity or permit back-projection of later equations. Complete Rev. 4 index/page effectivity still required. |
...
Research note 330 narrows the missing GSOP target to **Section 5 Revision 4** by recovering its historical index sheet inside the later cumulative Section 5 artifact. The sheet is itself cumulative: its dagger legend marks material added in Revision 7. That distinction must be preserved during retrieval. This remains a retrieval lead, not a completed effectivity chain.
...
1. Complete `R-567` Section 5 **Revision 4** revision-index pair, preserving Revision-7 later-addition markings, and establish LUMINARY 1A Rev. 099 effectivity.
