...
- `research/111_pc2_inverter_switch_identity.md` — records the earlier generic LM inverter-convention synthesis; superseded in part by mission-specific evidence in notes 112–118.
