...
- `source-catalog/PC2_INVERTER_WARNING_SOURCES.md` — focused source record for the mission-specific inverter-2 starting configuration, inverter-caution path, exact alternate-inverter transfer procedure, and note-115 fresh-valid-reobservation timing boundary; no unsupported numeric crew dwell is authorized.
...
- `research/111_pc2_inverter_switch_identity.md` — records the earlier generic LM inverter-convention synthesis; superseded in part by mission-specific evidence in notes 112–115.
