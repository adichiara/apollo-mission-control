...
| --- | --- | --- |
| NASA/MSC, _Apollo 11 Mission Report_, MSC-00171, Nov 1969, table 5-I | Five descent alarm event times: `102:38:22` 1202, `102:39:02` 1202, `102:42:18` 1201, `102:42:43` 1202, `102:42:58` 1202; P64 `102:41:32`; P66 `102:43:22` | Primary Mission-G postflight computer/event chronology. Use as audio-search anchors; do not equate with exact spoken-call timestamps. |
...
| NASA Apollo Lunar Surface Journal, Apollo 11 landing chronology | Air-ground chronology places first audible `Program Alarm` report at `102:38:26` and explicitly notes Mission Report/transcript timing differences | NASA-curated derivative navigation/cross-check source; do not substitute for primary audio or computer-event clock. |
...
The audio evidence has two complementary primary-recording routes. Historical Recorder #1 channels 21/22 and the restored corpus expose GUIDO L/R station recordings. Separately, NASA `792-AAI` is cataloged as Flight Director's Loop audio covering lunar descent 1955–2025.

The Mission Report now supplies the authoritative postflight event anchors for that comparison. Its five alarm timestamps are computer/event chronology, not exact voice timestamps. The NASA Lunar Surface Journal itself exposes a difference at the first event: `102:38:22` computer-determined in table 5-I versus Armstrong's audible `Program Alarm` at `102:38:26` in the journal chronology. Therefore recording clocks and event clocks must be reconciled rather than silently merged.

Neither recording route collapses the configuration boundary. Hearing a voice on GUIDO or Flight-loop audio cannot by itself identify the originating back-room circuit or complete talk privilege. Exact wording, timing, overlap, and speaker attribution require direct audio inspection.
...
- NASA/MSC Apollo 11 Mission Report: https://www.nasa.gov/wp-content/uploads/static/apollo50th/pdf/A11_MissionReport.pdf
...
- **DOCUMENTED / PRIMARY / MISSION-G-SPECIFIC TIMING:** five Mission Report alarm-event anchors and P64/P66 boundaries; event clock is not voice clock.
...
- **UNRESOLVED / MISSION-G-SPECIFIC:** exact named GUIDO/support loop, exact per-alarm spoken wording/timing/overlap, recording-clock reconciliation, GUIDO DRK labels/format mapping, FDK configuration, exact powered-descent display callups/cadence, channel identity, station-to-loop assignment, and complete keyset privileges.
