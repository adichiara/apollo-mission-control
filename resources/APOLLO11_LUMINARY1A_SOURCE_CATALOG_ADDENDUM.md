...
The numerical-error thread remains narrower than the performance envelope. LSP-470-2D gives 3-sigma acceptance limits; TN D-6849 supplies generally in-spec LM-5 behavior and cautions against a simple Gaussian simulator assumption. Historical stochastic LR generation remains **BLOCKED**.
