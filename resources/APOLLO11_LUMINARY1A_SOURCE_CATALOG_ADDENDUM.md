...
- **UNRESOLVED:** per-field Apollo 11 MSK-1137 `D/L`/`RTCC` mapping and exact external-name/downlist/computation provenance, GUIDO exact request workflow, and numeric dynamic-data cadence/latency/freshness.
