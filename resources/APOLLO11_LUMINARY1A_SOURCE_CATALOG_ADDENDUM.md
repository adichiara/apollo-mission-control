...
TN D-8316 separates dynamic-data update from CRT refresh and reference-slide access. The Apollo 12 flight manual further establishes that DRK direct-PBI requests and MSK display-request mode were alternate mechanisms for requesting RTCC display formats. Because that manual is Apollo 12, the project does not assign a DRK to Apollo 11 GUIDO without Apollo-11-effective evidence.
