...
- **UNRESOLVED:** `SKALSKAL = 00000` versus `.2 NOM` operational semantics; per-field MSK-1137 routing, GUIDO exact request workflow, controller-visible consequence of onboard reasonableness rejection, MCC dynamic-data cadence/latency/freshness, complete LM-5 raw serial encoding/high-range conversion/rounding/framing, and sub-second LR transition timing.
