...
Modern loop transcriptions and reconstructions may supply search terms, but exact Flight-loop wording/speaker attribution must be checked against the historical recording. The Flight-loop source also cannot substitute for GUIDO L/R when reconstructing station-local traffic.

## URLs

- https://apollojournals.org/alsj/a11/a11.landing.html
- https://ntrs.nasa.gov/citations/20160014392

## Evidence status

- **PRIMARY:** `792-AAI`, GOSS NET 1, Garman oral-history testimony within their stated scopes.
- **DISCOVERY/LISTENING AID:** Apollo Flight Journal synchronized descent presentation.
- **OPEN:** direct audio transcription/alignment and GUIDO L/R comparison.
