...
- Added research note 314 separating **operational friction** that belongs in the simulation from **interface friction** introduced by the modern implementation.
