...
### LM-5 operational calibration volume identified and archival locator narrowed

The same primary NASA-MSC transmittal records **Operational Calibration Curves, Vol. II — Cal. Curves for LM-5**, dated **12 June 1969**. Direct page inspection gives **Federal Records Center accession 72-A-1116**, **Record Group 255**, and **agency box 71**. The FRC-only box field shows **3751-30**, but it is struck/annotated and retained only as a legacy locator.

A new primary crosscheck from the NASA-MSC/NARA Apollo 12 launch-data listing records **Operational Calibration Curves Vol. I for CSM-108 (4 Jun 1969), Vol. II for LM-6 (6 Oct 1969), and Vol. III for SLV-AS-507 (1969)**. This establishes that the neighboring mission used the same vehicle-specific three-volume calibration-series pattern, with **Vol. II assigned to the LM**. It materially strengthens the interpretation of the Apollo 11 LM-5 catalog entry as part of a recurring operational-calibration series, while still providing no evidence about the actual LM-5 curve names or values.

The LM-5 document remains **mission-vehicle-specific and preflight-effective**, but no claim is made that it contains a DPS thrust, throttle, chamber-pressure, or FTP-force calibration. The actual volume must be recovered and opened before any evidence label is upgraded.

## Boundary preserved

No later-LM force calibration was back-projected onto Eagle. No preflight/design thrust was promoted to delivered thrust. No pattern-derived Apollo 11 report number was promoted to sourced metadata. The Apollo 12 series crosscheck is used only to establish document-series structure, not LM-5 contents. Archive metadata is treated strictly as locator/provenance evidence until underlying items are recovered. PDI mass remains unresolved.
...
Prioritize direct recovery of **Operational Calibration Curves, Vol. II — Calibration Curves for LM-5 (12 Jun 1969)** using **FRC accession 72-A-1116 / RG 255 / agency box 71** and inspect its actual channel/curve contents. The Apollo 12 parallel confirms the series structure but cannot substitute for LM-5 content. Continue direct recovery of **Mayer memorandum 69-FMZ2-149**, the **69-FM-156 base analysis and 2 July addendum**, and the two **8 July 1969 throttle-down dispersion items**. Continue the underlying Apollo 11 / LM-5 DPS Final Flight Evaluation contractor-report search and LM-5 engine acceptance/performance records in parallel. Retain page 2.3-25 and BET Volume II as named blocked targets.

## Evidence status

**PARTIALLY DOCUMENTED.** Primary NASA-MSC records metadata establishes an **LM-5-specific Operational Calibration Curves Volume II dated 12 June 1969** and narrows retrieval to **FRC accession 72-A-1116 / RG 255 / agency box 71**. A primary Apollo 12 launch-data listing independently confirms the recurring vehicle-specific calibration-volume structure and its assignment of **Vol. II to LM-6**. LM-5 contents remain **BLOCKED ON DOCUMENT RECOVERY**, so no DPS calibration value is claimed. Mayer memo **69-FMZ2-149** remains identified but content-blocked. The companion July studies and 69-FM-156 source states remain archival recovery targets. Supplement 7 identifiers/content and page 2.3-25 remain blocked. Exact LM-5 FTP force calibration, delivered thrust/Isp, and PDI mass remain unresolved. TRW BET Volume II remains **BLOCKED ON NAMED SOURCE RECOVERY**.