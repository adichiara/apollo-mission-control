...
- Research 404 inspected the LUMINARY 099 assembly listing itself. In the P66 path, `P66VERTA` loads `1SEC`, calls `TWIDDLE`, and schedules `RODTASK`; `RODTASK` dispatches `RODCOMP`.
