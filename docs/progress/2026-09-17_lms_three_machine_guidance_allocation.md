...
Research note 240 reviewed primary NASA simulator architecture evidence in *Apollo Experience Report — Simulation of Manned Space Flight for Crew Training* (`NASA-TN-D-7112`, `MSC-S-346`, NTRS `19730011149`).
...
- `resources/research/240_lms_three_machine_guidance_allocation.md`
...
The note was originally committed as research note 236 and renumbered to 240 after a parallel research stream independently used 236 for the Apollo 9 simulator-mismatch boundary.
