...
Research note 204 and `data/guidance_monitoring_profiles/apollo11_g_powered_descent_monitoring_partial.json` now source-bound part of the Apollo 11 configuration:
