...
- LMA790-3-LM figure 2.2-62 on **page 2.2-215, Change Date 15 Jun 1969**, labels the TTCA throttle hard-stop position **92.5% THRUST** and is directly within the LM-5 handbook state.
...
Purdue MSA 5 identifies **“Effect of fixed throttle point thrust on the time from loss of radial guidance control to DPS throttle-down,” 5 June 1969**. A primary NASA/MSC mission-techniques document independently cites that exact title as **John P. Mayer, Manned Spacecraft Center/Mission Planning and Analysis Division, NASA MSC Memorandum 69-FMZ2-149, 5 June 1969**. The OCR branch code is retained as `FMZ2` pending a clean title-page recovery. The citation identifies the document but does not expose its result, so no numerical FTP calibration is claimed.

Two companion Purdue items remain active: **“Effects of DPS engine dispersions and LM weight on throttle-down time”** and **“Effects of known dispersions at PDI on throttle-down time,”** both 8 Jul 1969. Their titles establish analyzed variables only; no numerical values are inferred.
...
The same primary transmittal supplies a more directly useful CONTROL recovery target on page 15: **Operational Calibration Curves, Vol. II — Calibration Curves for LM-5, dated 12 June 1969**. Page-image inspection gives **Federal Records Center accession 72-A-1116, Record Group 255, agency box 71**. The FRC-only field carries struck/annotated **3751-30**, retained only as a legacy locator.

A primary series crosscheck from the NASA-MSC/NARA **Apollo 12 launch-data listing** records **Operational Calibration Curves Vol. I — CSM-108 (4 Jun 1969), Vol. II — LM-6 (6 Oct 1969), and Vol. III — SLV-AS-507 (1969)**. This independently establishes that the neighboring mission used the same vehicle-specific three-volume calibration-series structure and assigned **Volume II to the LM**. This is useful provenance for the LM-5 recovery request, but it does **not** establish which channels or curves appear in the Apollo 11 volume and supplies no LM-5 numerical calibration.

A current official NARA Record Group 255 guide independently places **Manned Spacecraft Center / Johnson Space Center textual records in Fort Worth** and identifies the MSC/JSC field-installation series under **RG 255.4.7**. An official NARA article further states that more than 8,600 cubic feet of JSC records were transferred to the National Archives Southwest Region in Fort Worth as RG 255. This does not prove box 71's present shelf location, but it converts the next step from an undirected archive search into a **Fort Worth RG 255 reference request keyed to accession 72-A-1116 / agency box 71**. A fresh public-web/NASA/NTRS search did not surface a digitized copy of the LM-5 calibration volume, so the item remains correctly classified **BLOCKED ON DOCUMENT RECOVERY**, not merely unresolved by search.

The transmittal does **not** show 69-FMZ2-149 in the scanned Apollo 11 index, and no claim is made that memo 149 is in box 3751-33 or agency box 71.

The later H-2 lunar-descent document cites **69-FM-156, “G Mission Lunar Descent Dispersion Analysis,” 10 Jun 1969**, while Purdue catalogs **Internal Note 69-FM-156, Apollo 11 (Mission G) Spacecraft Dispersion Analysis, Vol. IV, Part 1 Lunar Descent (Addendum), 2 Jul 1969**. Treat the 10 June base analysis and 2 July addendum as related but distinct states until title pages are recovered.
...
1. Submit/recover **Operational Calibration Curves, Vol. II — Calibration Curves for LM-5 (12 Jun 1969)** as a **NARA Fort Worth RG 255** reference target using **FRC accession 72-A-1116 / agency box 71**; retain struck/annotated `3751-30` only as a secondary legacy locator. Ask for the box/folder inventory or digital reproduction before inferring contents.
...
**PARTIALLY DOCUMENTED.** Primary NASA-MSC records metadata establishes a mission-specific **LM-5 Operational Calibration Curves Volume II dated 12 June 1969** and narrows its archival key to **FRC accession 72-A-1116 / RG 255 / agency box 71**. Official NARA RG 255 guidance independently places MSC/JSC textual records in **Fort Worth**, making NARA Fort Worth the evidence-supported next reference route while not asserting a present shelf location for box 71. A fresh public search did not recover the volume itself. The LM-5 volume therefore remains **BLOCKED ON DOCUMENT RECOVERY** and no DPS calibration is inferred. The 5 June FTP study, two 8 July companion studies, 69-FM-156 source states, page 2.3-25, Supplement 7 content/identifiers, exact LM-5 force calibration/delivered performance, PDI mass, and TRW Volume II remain unresolved/blocked as documented.