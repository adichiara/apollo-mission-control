...
1. Request/recover **Operational Calibration Curves, Vol. II — Calibration Curves for LM-5 (12 Jun 1969)** using **FRC accession 72-A-1116 / RG 255 / agency box 71**; retain struck/annotated `3751-30` only as a secondary legacy locator. Inspect the actual volume for DPS/throttle/pressure/control-to-engineering-unit calibration. Use the Apollo 12 Vol. I/II/III listing only as series-structure evidence.
