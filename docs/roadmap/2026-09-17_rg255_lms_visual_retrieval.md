...
Research note 300 clarifies provenance: **E.155B is the 20-foot Reference Files on the Lunar Landing Training Vehicle series**, whose description says it also contains some LMS MEP/EVDE material. E.155B1, by contrast, is explicitly the dedicated *Project Files on the Lunar Module Simulator*. Treat E.155B as a narrow MEP/EVDE subset-retrieval target, not as an LMS visual-system collection.
