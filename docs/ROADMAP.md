...
**Status:** first reference scenario integrated; generic scenario catalog/selection and minimal mission-profile boundaries implemented; additional runtime adapters and scenario authoring remain.
