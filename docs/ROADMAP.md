...
**Status:** first reference scenario executable; second source-bounded Apollo 11 reference fixture cataloged as non-executable; generic scenario/profile/runtime boundaries implemented.
