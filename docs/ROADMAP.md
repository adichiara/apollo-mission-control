...
The primary research chain now runs through notes **048–127**. Notes 098–103 establish the final-load, support-room, post-burn, spacecraft-model, and ground-data-processing boundaries. Notes 104–127 further constrain the PC+2 observation and shutdown-rule evidence paths, including inlet-pressure and thrust-monitor semantics, attitude-transient handling, inverter transfer/re-observation, ground inverter telemetry, TELMU station continuity, crew-local electrical monitoring, H-2 PHO-TR155 provenance/implementation, mission-specific H-2 TDFCB telemetry configuration, the PHO-TR155 data-pack lineage boundary, and the data-pack-to-PHO-TR155 process boundary.
...
Research notes **125–127** add a historical configuration-control boundary above this functional model. Mission H-2 TDFCB Revision 4 carried mission-specific telemetry-format/Flight Control products and its PCMGS material was checked against PHO-TR155. PHO-TR155 itself was prepared by Requirements and Configuration from information gathered through data-pack circulation; preliminary PHO-TR155 working lists then supported display-production work. Because the contents/scope of H-2 Revision N are unrecovered, it cannot substitute for an exact TELMU loading source or be treated as synonymous with PHO-TR155 Revision C. Neither archival gap may be filled with guessed H-2 parameter loading or adjacent-mission sample rates.
...
9. Continue the archival search for **Mission H-2 data-pack Revision N or its transmittal/index**, a **Requirements and Configuration data-pack definition/key**, **PHO-TR155 Mission H-2 Revision C**, and **Mission H-2 TDFCB Revision 4** (especially special LM Flight Control and PCMGS listings); do not assume Revision N is TELMU-specific or synonymous with PHO-TR155, and do not block physical validation on recovery.
...
Research notes 095–127 and associated testing/scope documentation improve physical-run evidence quality and scenario closure but do not constitute physical validation. Physical seven-seat and five-player compact human/device PASS claims remain unmade.