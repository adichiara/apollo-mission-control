...
7. The first generic electrical-power/equipment-availability model is now implemented. Next add reusable energy/consumable depletion and then connect instrumentation/telemetry/ground products to sourced physical/logical availability states.
