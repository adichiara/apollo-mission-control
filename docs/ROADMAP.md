...
**Status:** first reference scenario integrated; generic scenario catalog/selection boundary implemented; additional runtime adapters and scenario authoring remain.
