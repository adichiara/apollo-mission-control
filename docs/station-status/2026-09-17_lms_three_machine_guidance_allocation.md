...
Research note 244 strengthens the simulator-side architecture used to generate training inputs/products: primary NASA TN D-7112 defines the mature LMS as a three-machine digital computer complex and explicitly assigns one machine to onboard-guidance-computer simulation.
