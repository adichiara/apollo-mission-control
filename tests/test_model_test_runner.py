...
class ModelTestRunnerTests(unittest.TestCase):
    def test_route_and_report_contract(self):
        ...
        for required in ("Download report", "Copy report", "schema_version",
                         ...
                         "Historical vehicle measurement profile → blocked ground product",
                         ...
                         "Project controller products",
                         "Sparse LR-only proof",
                         ...
                         "Contradictory CAPCOM relay",
                         "Missing known fields are not derived from onboard truth.",
